...
: ${AMENT_CURRENT_PREFIX:="/anubi/install/sim_worlds"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sim_worlds/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sim_worlds/environment/path.sh"
