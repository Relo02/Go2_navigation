...
: ${AMENT_CURRENT_PREFIX:="/anubi/install/robot_safety"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_safety/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot_safety/environment/path.sh"
