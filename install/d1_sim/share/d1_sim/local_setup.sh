...
: ${AMENT_CURRENT_PREFIX:="/anubi/install/d1_sim"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/d1_sim/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/d1_sim/environment/path.sh"
