...
: ${AMENT_CURRENT_PREFIX:="/anubi/install/sensor_models"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sensor_models/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sensor_models/environment/path.sh"
